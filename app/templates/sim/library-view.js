...
module.exports = {
        ...
        onLoad: function () {
            ...
            const templateBase = new TemplateBase({
                templateType: 'sim',
                subjectFormat: 'sim-library-view',
                fields: {
                    vip: 'isVIP',
        ...
        if (demoButton) {
            ...
            const templateConfig = window.TRACKER_CONFIGS_FROM_TEMPLATES['sim-library-view'] || module.exports;
            demoButton.addEventListener('click', () => {
                console.log('Demo button clicked for sim-library-view template');
