// Import the function directly from the exports file
const { debugDistrictSubmission } = require('../app/scripts/app-exports');

describe('debugDistrictSubmission from app-exports', () => {
    ...
    test('should handle empty custom_fields object', () => {
        ...
        // No fields should be logged since forEach on an empty object won't execute
        expect(console.log).toHaveBeenCalledWith('Custom fields being submitted:');
